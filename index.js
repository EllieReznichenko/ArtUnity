import{a as A,S as O,N,P as j,R as H}from"./assets/vendor-BuJqGh_H.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();const D="https://sound-wave.b.goit.study/api",M=8;function V(e){alert(e)}async function R(){const e=await fetch(`${D}/artists`);if(!e.ok)throw new Error("Не вдалося завантажити артистів для hero");return await e.json()}async function P(e=1,t=8){const r=await fetch(`${D}/artists?page=${e}&limit=${t}`);if(!r.ok)throw new Error("Не вдалося завантажити артистів");return await r.json()}const F="https://sound-wave.b.goit.study/api/feedbacks";async function Q(){try{const e=await fetch(F);if(!e.ok)throw new Error("Failed to load feedbacks");return(await e.json()).data}catch(e){return console.error(e),[]}}async function G(e){try{return(await A.post(F,e)).data}catch(t){throw console.error("Помилка при відправці фідбеку:",t),t}}const I=document.querySelector(".column-left"),B=document.querySelector(".column-right");async function K(){try{const t=(await R()).artists,r=10;for(let s=0;s<r;s++)t.forEach((n,o)=>{var d,m,u;const c=((d=n.strArtistThumb)==null?void 0:d.trim())||((m=n.image)==null?void 0:m.trim())||((u=n.photoUrl)==null?void 0:u.trim())||null;if(!c)return;const a=n.strArtist||n.name||"Unknown Artist";if(!c)return;const i=document.createElement("img");i.src=c,i.alt=a,i.classList.add("hero-img"),o%2===0?I.appendChild(i.cloneNode(!0)):B.appendChild(i.cloneNode(!0))});I.classList.add("animate-up"),B.classList.add("animate-down")}catch(e){console.error("Error loading hero artists:",e)}}K();const X="/ArtUnity/assets/sprite-ItzP6nrU.svg",g={artistCardsContainer:document.querySelector("#artists-grid"),loadMoreBtn:document.getElementById("load-more-btn")};function W({_id:e,strArtist:t,genres:r,strArtistThumb:s,strBiographyEN:n}){const o=(r||[]).map(i=>`<span class="genre">${i}</span>`).join(""),c=(n==null?void 0:n.length)>100?n.slice(0,100)+"...":n||"",a=s&&typeof s=="string"&&s.trim()!==""?s:"/img/artists/Placeholder_Image.jpg";return`
